...
const DynamicStackedBarChartComponent = ({ 
  ...
  mode = 'auto', // Optional: 'stacked', 'grouped', 'difference', or 'auto'
  ...
  }, [data, xAxisKey, valueKey, categoryKey, mode]);

  // Generate colors for each category/metric
  ...
  const chartColors = generateColors(processedData.categories?.length || 0);
